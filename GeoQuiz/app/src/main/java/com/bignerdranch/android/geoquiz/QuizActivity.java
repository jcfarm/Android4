...
public class QuizActivity extends AppCompatActivity {
        ...
        mPrevButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (mCurrentIndex){
                    case 0:mCurrentIndex=(mQuestionBank.length-1);
                        break;
                    default:mCurrentIndex=(mCurrentIndex-1);
                        break;
                }
                updateQuestion();
                mIsCheater=false;
    ...
    public void onSaveInstanceState(Bundle savedIntenceState){
        ...
        savedIntenceState.putInt(KEY_INDEX,mCurrentIndex);
        savedIntenceState.putBoolean(KEY_ISCHEAT,mIsCheater);
